...
contract MessagingSystem {
    ...
    event MessageSent(uint256 indexed messageId, address indexed sender, address indexed receiver, string content, uint256 timestamp);
...
// }
    ...
    function sendMessage(address _receiver, string memory _content) public  {
        ...
        emit MessageSent(nextMessageId, msg.sender, _receiver, _content, block.timestamp);
    ...
    function getUserMessages(address _userAddress) public view returns (uint256[] memory) {
